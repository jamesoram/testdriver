...
public final class JtereportGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,3,3,3,3,24,24,24,26,26,26,26,26,26,26,27,27,29,29,31,31,33,33,36,36,37,37,38,38,38,38,38,38,38,38,38,39,39,40,40,40,40,40,40,40,40,40,41,41,43,43,43,53,53,54,54,58,58,58,63,63,63,68,68,68,68,68,68,68,68,68,69,69,69,69,69,69,69,69,69,74,74,76,76,76,77,77,77,80,80,82,82,82,83,83,83,86,86,87,87,92,92,97,97,97,3,3,3,3};
		...
		for (String method : results.getMethods()) {
			...
			for (LogEntry entry : results.getEntries(method)) {
				...
				if (entry.getLogLevel().equals(LogLevel.ASSERTION) && results.isFailed(method)) {
					...
					jteOutput.writeContent("/>\n                                        </a>\n                                    </div>\n                                </td>\n                            </tr>\n                        ");
				} else if (entry.getLogLevel().equals(LogLevel.USER)) {
