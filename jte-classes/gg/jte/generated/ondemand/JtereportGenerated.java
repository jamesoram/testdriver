...
public final class JtereportGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,2,2,2,28,28,28,30,30,30,31,31,31,32,32,32,34,34,38,38,38,2,2,2,2};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, BasicTestdriverLogger logger) {
	...
	public static void renderMap(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, java.util.Map<String, Object> params) {
		BasicTestdriverLogger logger = (BasicTestdriverLogger)params.get("logger");
		render(jteOutput, jteHtmlInterceptor, logger);
	}
}
